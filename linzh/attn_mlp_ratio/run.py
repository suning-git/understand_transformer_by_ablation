"""run.py — train each arm through nanoinfra's orchestrator and collect val curves.

Self-contained: works both inside a nanoinfra checkout and as a standalone folder.

    python run.py            # trains standard, attn_heavy, mlp_heavy
    python plot.py           # -> attn_mlp_ratio.png
"""
